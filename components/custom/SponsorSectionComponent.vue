...
<template>
  <div class="bg-green ml-[-120px] w-[1440px] flex items-center space-x-[79.6px] px-[221px] py-[47.57px] mb-[160px] max-sm:mb-[64px] max-sm:w-[375px] max-sm:px-1 max-sm:ml-[-24px]">
